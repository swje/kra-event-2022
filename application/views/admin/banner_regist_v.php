<div class="pageheader">
	<h2><i class="fa fa-picture-o"></i> <?php echo $banner_type_kor;?> 추가</h2>
	<div class="breadcrumb-wrapper">
	<span class="label">현재위치:</span>
	<ol class="breadcrumb">
		<li>메인 관리</li>
		<li class="active"><?php echo $banner_type_kor;?> 추가</li>
	</ol>
	</div>
</div>
	
<div class="contentpanel">
	<form id="basicForm" action="/conn-admin/banner/regist" class="form-horizontal" method="POST" enctype="multipart/form-data" >
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="banner_name" class="form-control" value="" placeholder="" required/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="imagePreview mt10" id="imagePreview"></div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="imagePreview mt10" id="imagePreview-M"></div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<div class="rdio rdio-primary">
						<input type="radio" id="use_y" value="Y" name="banner_use_yn" checked="checked" />
						<label for="use_y">사용</label> 
					</div><!-- rdio -->
					<div class="rdio rdio-primary">
						<input type="radio" id="use_n" value="N" name="banner_use_yn" />
