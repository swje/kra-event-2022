<div class="pageheader">
	<h2><i class="fa fa-question"></i> FAQ 추가</h2>
	<div class="breadcrumb-wrapper">
	<span class="label">현재위치:</span>
	<ol class="breadcrumb">
		<li>FAQ</li>
		<li class="active">FAQ 추가</li>
	</ol>
	</div>
</div>
	
<div class="contentpanel">
	<form id="basicForm" action="/conn-admin/board/write" class="form-horizontal" method="POST" enctype="multipart/form-data" >
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" name="board_title" class="form-control" value="" placeholder="질문을 입력하세요." required/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Answer <span class="asterisk">*</span></label>
				<div class="col-sm-10">
					<textarea type="text" id="editor_content" name="board_content" class="form-control" value="" autocomplete="off" placeholder="답변을 입력하세요" required></textarea>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<div class="rdio rdio-primary">
						<input type="radio" id="use_y" value="Y" name="board_use_yn" checked="checked" />
						<label for="use_y">사용</label> 
					</div><!-- rdio -->
					<div class="rdio rdio-primary">
						<input type="radio" id="use_n" value="N" name="board_use_yn" />
