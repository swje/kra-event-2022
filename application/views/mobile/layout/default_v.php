...
<!--<div class="gnb">
	<ul>
		<li class="hover"><a href="main.html">LetsRun 무료입장권 이벤트</a></li>
		<li><a href="information_enter.html">정보입력</a></li>
...
<div class="footer" style="background: url(<?php echo $footer_back;?>);">
	<div class="footer_inner">
        ...
        <div class="icon_list">
            <a href="javascript:toSNS('blog','렛츠런파크 이벤트','http://<?php echo $_SERVER['HTTP_HOST'];?>')"><img src="/static-m/image/icon_n.png" alt="네이버"/></a>
            <a href="javascript:sendKakaoTalk();"><img src="/static-m/image/icon_k.png" alt="카카오톡"/></a>
            <a href="javascript:toSNS('facebook','렛츠런파크 이벤트','http://<?php echo $_SERVER['HTTP_HOST'];?>')"><img src="/static-m/image/icon_f.png" alt="페이스북"/></a>
            <a href="javascript:toSNS('twitter','렛츠런파크 이벤트','http://<?php echo $_SERVER['HTTP_HOST'];?>')"><img src="/static-m/image/icon_t.png" alt="트위터"/></a>
        </div>
    </div>    
