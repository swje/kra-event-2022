...
<?php
	...
	$SITE_URL 	=   "www.letsrun-event.co.kr";
	...
	$RETURN_URL = "http://".$_SERVER['HTTP_HOST']."/okcert3/phone_popup3.php";// 인증 완료 후 리턴될 URL (도메인 포함 full path)
	...
	$license = "/home/letsrunevent/okcert3/".$CP_CD."_IDS_01_".$target."_AES_license.dat";
	...
	**************************************************************************/
	...
	//$params .= '"IN_TP_BIT":"'.'15'.'",';
	//$params .= '"NAME":"'.'홍길동'.'",';
	//$params .= '"BIRTHDAY":"'.'19870725'.'",';
	//$params .= '"TEL_NO":"'.'01012345678'.'",';
	//$params .= '"NTV_FRNR_CD":"'.'F'.'",';// 내국인 L 외국인 F
	//$params .= '"SEX_CD":"'.'F'.'",';		// 남성 M 여성 F
